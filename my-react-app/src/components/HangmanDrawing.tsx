...
const BODY_PARTS = [HEAD, BODY, RIGHT_ARM, LEFT_ARM, RIGHT_LEG, LEFT_LEG] //SHOULD BE IN ORDER
...
export function HangmanDrawing({ numberOfGuesses }: HangmanDrawingProps) {
    return (
        ...
        // there we utilized the slice method,we start from the 0 index and we want to get all the elements up to the point of number of guesses
    )
}